...
class Utils {
    ...
    adjustFontSize(button) {
        ...
        // 如果文本宽度超出按钮宽度，则减小字体大小
        while (tempDiv.scrollWidth > buttonWidth && fontSize > minHeight) {
            fontSize -= 0.5;
            tempDiv.style.fontSize = fontSize + 'px';
        }
        
        // 如果文本宽度远小于按钮宽度且字体大小小于原始大小，则增大字体大小
        while (tempDiv.scrollWidth < buttonWidth * 0.8 && fontSize < originalFontSize) {
            fontSize += 0.5;
            tempDiv.style.fontSize = fontSize + 'px';
            
            // 如果增大后超出了按钮宽度，则停止增大
            if (tempDiv.scrollWidth > buttonWidth) {
                fontSize -= 0.5;
                tempDiv.style.fontSize = fontSize + 'px';
                break;
            }
